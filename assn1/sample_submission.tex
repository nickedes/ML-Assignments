...
I also ran K-NN for values of k other than those provided in question i.e., for these set of k values = \left [1, 2, 3, 5, 10, 15, 20, 50, 100, 200, 500, 1000, 2000, 5000, 10000, 20000] \right ]. The plot for accuracy vs K is :
...
Observation : The Accuracy of KNN increases only till a value of k, and then it starts to decrease. Accuracy increases only till k = 15 and then starts to decrease slowly and steadily.\\\\
